...
class AboutUsController extends Controller
{
    ...
    public function update(Request $request)
    {
        ...
        if (empty($aboutUsInfo)) {
            $imageName = UploadFile::store('./img/about-us-section/', $request->file('image'));
            ...
            if ($request->hasFile('image')) {
                $imageName = UploadFile::update('./img/about-us-section/', $request->file('image'), $aboutUsInfo->image);
            }
