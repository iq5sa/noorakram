...
Route::get('/payment/credit/redirect', [\App\Http\Controllers\FrontEnd\PaymentGateway\TabadulPayment::class, "redirect"])->name('credit.payment.redirect');
...
Route::post("/appointment/book/payment", "FrontEnd\AppointmentsController@payment")->name("appointment.payment");
