...
@section('content')
    @includeIf('frontend.partials.breadcrumb', ['img' => $breadcrumbImg, 'title' => $pageHeading ?? 'Login'])
                ...
                <div class="row justify-content-center justify-content-lg-between align-items-center">
                    <div class="col-12 col-sm-12 col-lg-7 col-xl-6 col-md-8">
                        <div class="card shadow zindex-100 mb-0">
                            <div class="card-body px-md-5 py-5">
                                ...
                                <form role="form" action="{{ route('user.login_submit') }}" method="POST">
                                    ...
                                    <div class="form-group">
                                        <label for="input-email" class="form-control-label">البريد الإلكتروني</label>
                                        ...
                                        <div class="d-flex align-items-center justify-content-between">
                                            ...
                                            <div class="mb-2">
                                                <a href="{{ route('user.forget_password') }}"
                                                   class="small text-muted text-underline--dashed border-primary">هل
                                                    نسيت كلمة المرور؟</a>
                                            </div>
                                        </div>
                                        <div class="input-group">
                            ...
                            <div class="card-footer px-md-5"><small>ليس لديك حساب؟</small>
                                <a href="{{route("user.signup")}}" class="small font-weight-bold">انشئ حساب جديد.</a>
                            </div>
                        </div>
                    </div>
