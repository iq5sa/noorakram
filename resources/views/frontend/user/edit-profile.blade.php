...
@section('content')
    @includeIf('frontend.partials.breadcrumb', ['img' => $breadcrumbImg, 'title' => __('Edit Profile')])
                                    ...
                                    <div class="edit-info-area">
                                        <form action="{{ route('user.update_profile') }}" method="POST"
                                            ...
                                            <div class="upload-img">
                                                <div class="img-box">
                                                    <img
                                                            data-src="{{ is_null($authUser->image) ? asset('/img/profile.jpg') : asset('/img/users/' . $authUser->image) }}"
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-6">
                          <textarea class="form_control" placeholder="{{ __('Address') }}"
                                    name="address">{{ $authUser->address }}</textarea>
                                                    @error('address')
                                                    <p class="mb-3 text-danger">{{ $message }}</p>
                                                    @enderror
                                                </div>
