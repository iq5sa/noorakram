                                                                 ...
                                                                 xml:space="preserve" class=""><g
                                                                    ...
                                                                    <g fill="#fff">
                                                                        <circle cx="256" cy="196.23" r="51.43"
                                                                                ...
                                                                                class=""></circle>
                                                                        <path d="M231 260.49h50a64.44 64.44 0 0 1 64.44 64.44v27.7a14.55 14.55 0 0 1-14.55 14.55H181.08a14.55 14.55 0 0 1-14.55-14.55v-27.7A64.44 64.44 0 0 1 231 260.49z"
                                                                              fill="#ffffff" opacity="1"
                        ...
                        <div class="course-sidebar-btns p-3">
                                ...
                                @else
                                    <form action="{{ route('course.enrol', ['id' => $details->id]) }}"
                                        ...
                                        <button class="btn btn-primary btn-lg w-100 mb-4"
                                                type="submit"><i
                                                    class="fal fa-user-graduate"></i> انضم ألآن
                                        </button>
                                    </form>
                            ...
                            @guest("web")
                                <form action="{{ route('course.enrol', ['id' => $details->id]) }}"
                                      method="POST" enctype="multipart/form-data">
                                    @csrf
                                    <button class="btn btn-primary btn-lg font-weight-bold w-100 mb-4"
                                            type="submit"><i
