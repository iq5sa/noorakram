...
@section('content')
    ...
    <section class="slice min-vh-100 d-flex align-items-center bg-light">
        <!-- SVG background -->
        ...
        <div class="container py-1 py-lg-5 px-md-0 d-flex align-items-center" style="z-index: 101">
            <div class="w-100">
                <div class="row justify-content-center justify-content-lg-between align-items-center">
                    <div class="col-12 col-sm-12 col-lg-7 col-xl-6 col-md-8">
                        <div class="card shadow zindex-100 mb-0">
                            <div class="card-body px-md-5 py-5">
                                <div class="mb-5">
                                    <h6 class="h3">إنشاء حساب جديد</h6>
                                    <p class="text-muted mb-0">قم بإنشاء حساب جديد في منصتنا لتتمكن من الوصول لجميع
                                        خدماتنا.</p>
                                </div>
                                ...
                                <form action="{{ route('user.signup_submit') }}" method="POST">
                                    ...
                                    <div class="input-box mb-4">
                                        <label for="username"
                                               class="label text-secondary">{{ __('Username') . ':' }}</label>
                                      ...
                                      <span class="input-group-text">
                                        <i class="fal fa-edit"></i>
                                            ...
                                            <input id="username" type="text" class="form-control" name="username"
                                                   value="{{ old('username') }}"
                                                   placeholder="علي محمد" required
                                                   oninvalid="this.setCustomValidity('اسم المستخدم مطلوب')"
                                    ...
                                    <div class="input-box mb-4">
                                        <label for="email"
                                               class="label text-secondary">{{ __('Email Address') . ':' }}</label>
                                        <div class="input-group">
                                            <div class="input-group-append">
                                            ...
                                            <input id="email" type="email" class="form-control" name="email"
                                                   ...
                                                   oninvalid="this.setCustomValidity('البريد الإلكتروني مطلوب')"
                                                   oninput="this.setCustomValidity('')">
                                    ...
                                    <div class="input-box mb-4">
                                        <label for="password"
                                               class="label text-secondary">{{ __('Password') . ':' }}</label>
                                        <div class="input-group ">
                                            <div class="input-group-append">
                                                <div class="input-group-text">
                                    ...
                                    <div class="input-box mb-4">
                                        <label for="confirm_password"
                                               class="label text-secondary">{{ __('Confirm Password') . ':' }}</label>
                                        <div class="input-group ">
                                            <div class="input-group-append">
                                                <div class="input-group-text">
                                                    <i class="fal fa-key"></i>
                                            ...
                                            <input id="confirm_password" type="password" class="form-control"
                                                   ...
                                                   oninvalid="this.setCustomValidity('تأكيد كلمة المرور مطلوب')"
                                                   oninput="this.setCustomValidity('')">
                                    ...
                                    <div class="mt-4 mb-4">
                                        <button type="submit" class="btn btn-primary btn-icon rounded-pill btn-lg">
                                            <span class="btn-inner--text">اشتــراك</span>
                            ...
                            <div class="card-footer px-md-5"><small>لديك حساب سابق؟</small>
                                <a href="{{route("user.login")}}" class="small font-weight-bold"> تسجيل الدخول </a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-5 col-xl-5 col-md-4 d-none d-lg-block">
                        <blockquote>
                            <h3 class="h2 mb-4"> نهدف الى توفير برامج تدريبية فعالة مستمدة من الفجوات التي نراها كمختصين
                                بوطننا العربي.</h3>
                            <footer>— <cite class="text-lg">أكاديمية نور اكرم</cite></footer>
                        </blockquote>
                    </div>
                </div>
            </div>
