                                ...
                                <div class="form-group">
                                    <div class="selectgroup selectgroup-pills">
                                        ...
                                        <label class="selectgroup-item">
                                            <input type="checkbox" class="selectgroup-input" name="permissions[]"
                                                   value="Instructors"
                                                   @if (is_array($rolePermissions) && in_array('Instructors', $rolePermissions)) checked @endif>
                                        ...
                                        <label class="selectgroup-item">
                                            <input type="checkbox" class="selectgroup-input" name="permissions[]"
                                                   ...
                                                   @if (is_array($rolePermissions) && in_array('Course Management', $rolePermissions)) checked @endif>
                                            <span class="selectgroup-button">{{ __('Course Management') }}</span>
                                        </label>

                                        <label class="selectgroup-item">
                                            <input type="checkbox" class="selectgroup-input" name="permissions[]"
                                                   value="Course Enrolments"
                                                   @if (is_array($rolePermissions) && in_array('Course Enrolments', $rolePermissions)) checked @endif>
