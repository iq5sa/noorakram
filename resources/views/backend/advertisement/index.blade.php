                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @if ($ad->ad_type == 'banner')
                                                        <img src="{{ asset('/img/advertisements/' . $ad->image) }}"
                                                             alt="ad image"
                                                             width="45">
                                                    @else
                                                        -
                                                ...
                                                <td>
                                                    <a class="btn btn-secondary btn-sm mr-1 editBtn" href="#"
                                                       data-toggle="modal"
                                                       data-target="#editModal" data-id="{{ $ad->id }}"
                                                       data-ad_type="{{ $ad->ad_type }}"
                                                       data-resolution_type="{{ $ad->resolution_type }}"
                                                       data-image="{{ $ad->ad_type == 'banner' ? asset('/img/advertisements/' . $ad->image) : asset('/img/noimage.jpg') }}"
