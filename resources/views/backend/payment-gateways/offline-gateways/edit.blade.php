        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="ajaxEditForm" class="modal-form"
                      action="{{ route('admin.payment_gateways.update_offline_gateway') }}" method="POST">
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="in_short_description" class="form-control" name="short_description" rows="3"
                                  cols="80" placeholder="Enter Short Description"></textarea>
                    </div>
