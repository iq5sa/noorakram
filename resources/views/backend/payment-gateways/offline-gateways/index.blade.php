                        ...
                        <div class="col-lg-4 offset-lg-4 mt-2 mt-lg-0">
                            <a href="#" data-toggle="modal" data-target="#createModal"
                               class="btn btn-primary btn-sm float-right"><i
                                        class="fas fa-plus"></i> {{ __('Add Gateway') }}</a>
                        </div>
                    </div>
                </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <form id="statusForm-{{ $offlineGateway->id }}"
                                                          ...
                                                          method="post">
                                                        @csrf
                                                        <select class="form-control form-control-sm {{ $offlineGateway->status == 1 ? 'bg-success' : 'bg-danger' }}"
                                                                name="status"
                                                ...
                                                <td>
                                                    <a class="btn btn-secondary btn-sm editBtn mr-1" href="#editModal"
