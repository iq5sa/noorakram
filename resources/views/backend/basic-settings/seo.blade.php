                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="meta_description_home" rows="5"
                                              placeholder="Enter Meta Description">{{ $data != null ? $data->meta_description_home : '' }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="meta_keyword_courses"
                                           value="{{ $data != null ? $data->meta_keyword_courses : '' }}"
                                           placeholder="Enter Meta Keywords" data-role="tagsinput">
                                </div>

                                <div class="form-group">
                                    <label>{{ __('Meta Description For Courses Page') }}</label>
                                    <textarea class="form-control" name="meta_description_courses" rows="5"
                                              placeholder="Enter Meta Description">{{ $data != null ? $data->meta_description_courses : '' }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="meta_keyword_instructors"
                                           value="{{ $data != null ? $data->meta_keyword_instructors : '' }}"
                                           placeholder="Enter Meta Keywords" data-role="tagsinput">
                                </div>

                                <div class="form-group">
                                    <label>{{ __('Meta Description For Instructors Page') }}</label>
                                    <textarea class="form-control" name="meta_description_instructors" rows="5"
                                              placeholder="Enter Meta Description">{{ $data != null ? $data->meta_description_instructors : '' }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="meta_description_blog" rows="5"
                                              placeholder="Enter Meta Description">{{ $data != null ? $data->meta_description_blog : '' }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="meta_description_faq" rows="5"
                                              placeholder="Enter Meta Description">{{ $data != null ? $data->meta_description_faq : '' }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="meta_description_contact" rows="5"
                                              placeholder="Enter Meta Description">{{ $data != null ? $data->meta_description_contact : '' }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="meta_keyword_login"
                                           value="{{ $data != null ? $data->meta_keyword_login : '' }}"
                                           placeholder="Enter Meta Keywords" data-role="tagsinput">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="meta_description_login" rows="5"
                                              placeholder="Enter Meta Description">{{ $data != null ? $data->meta_description_login : '' }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="meta_keyword_signup"
                                           value="{{ $data != null ? $data->meta_keyword_signup : '' }}"
                                           placeholder="Enter Meta Keywords" data-role="tagsinput">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="meta_description_signup" rows="5"
                                              placeholder="Enter Meta Description">{{ $data != null ? $data->meta_description_signup : '' }}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" name="meta_keyword_forget_password"
                                           value="{{ $data != null ? $data->meta_keyword_forget_password : '' }}"
                                           placeholder="Enter Meta Keywords" data-role="tagsinput">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="meta_description_forget_password" rows="5"
                                              placeholder="Enter Meta Description">{{ $data != null ? $data->meta_description_forget_password : '' }}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
