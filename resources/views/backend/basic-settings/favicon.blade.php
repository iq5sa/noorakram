                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-6 offset-lg-3">
                            <form id="imageForm" action="{{ route('admin.basic_settings.update_favicon') }}"
                                  method="POST"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="thumb-preview">
                                        @if (!empty($data->favicon))
                                            <img src="{{ asset('/img/' . $data->favicon) }}" alt="favicon"
                                                 class="uploaded-img">
                                        @else
                                    ...
                                    @endif
                                    <p
                                            class="text-warning mt-2 mb-0">{{ __('Upload 40X40 pixel size image or squre size image for best quality.') }}</p>
                                </div>
                            </form>
                        </div>
                    </div>
