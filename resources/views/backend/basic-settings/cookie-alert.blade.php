                        ...
                        <div class="col-lg-6 offset-lg-3">
                            <form id="ajaxForm"
                                    ...
                                    <div class="selectgroup w-100">
                                        <label class="selectgroup-item">
                                            <input type="radio" name="cookie_alert_status" value="1"
                                                   class="selectgroup-input" {{ $data != null && $data->cookie_alert_status == 1 ? 'checked' : '' }}>
                                            <span class="selectgroup-button">{{ __('Active') }}</span>
                                        </label>

                                        <label class="selectgroup-item">
                                            <input type="radio" name="cookie_alert_status" value="0"
                                                   class="selectgroup-input" {{ $data != null && $data->cookie_alert_status == 0 ? 'checked' : '' }}>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control summernote" name="cookie_alert_text"
                                              data-height="120">{{ $data != null ? replaceBaseUrl($data->cookie_alert_text, 'summernote') : '' }}</textarea>
