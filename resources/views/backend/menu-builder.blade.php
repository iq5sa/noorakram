                            ...
                            <div class="card border-primary mb-3">
                                ...
                                <div class="card-body">
                                    <ul class="list-group">
                                        ...
                                        <li class="list-group-item">
                                            {{ __('Courses') }} <a href="" data-text="{{ __('Courses') }}"
                                                                   data-type="courses"
                                                                   class="addToMenus btn btn-primary btn-sm float-right">{{ __('Add To Menus') }}</a>
                                        </li>
                                        <li class="list-group-item">
                                            {{ __('Instructors') }} <a href="" data-text="{{ __('Instructors') }}"
...
@section('script')
    <script type="text/javascript" src="{{ asset('/js/jquery-menu-editor.min.js') }}"></script>
    ...
    <script type="text/javascript" src="{{ asset('/js/menu-builder.js') }}"></script>
@endsection
