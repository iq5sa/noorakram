        ...
        <div class="col-md-12">
            <div class="card">
                <form id="ajaxEditForm"
                      action="{{ route('admin.instructor.update_social_link', ['id' => $socialLink->id]) }}"
                      method="post">
                        ...
                        <div class="row">
                            <div class="col-lg-6 offset-lg-3">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="url" class="form-control" name="url" value="{{ $socialLink->url }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" name="serial_number"
                                           value="{{ $socialLink->serial_number }}" placeholder="Enter Serial Number">
