...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <form id="ajaxForm"
                      action="{{ route('admin.instructor.store_social_link', ['id' => $instructor->id]) }}"
                      method="post">
                    @csrf
                    <div class="card-header">
                        ...
                        <a class="btn btn-info btn-sm float-right d-inline-block"
                           href="{{ route('admin.instructors', ['language' => $defaultLang->code]) }}">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a class="btn btn-secondary btn-sm mr-1"
                                                       href="{{ route('admin.instructor.edit_social_link', ['instructor_id' => $socialLink->instructor_id, 'id' => $socialLink->id]) }}">
                              <span class="btn-label">
                                <i class="fas fa-edit"></i>
                                                    ...
                                                    <form class="d-inline-block deleteForm"
                                                          action="{{ route('admin.instructor.delete_social_link', ['id' => $socialLink->id]) }}"
                                                          method="post">
