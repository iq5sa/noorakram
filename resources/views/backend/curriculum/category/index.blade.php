                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 offset-lg-1 mt-2 mt-lg-0">
                            ...
                            <button class="btn btn-danger btn-sm float-right mr-2 d-none bulk-delete"
                                    data-href="{{ route('admin.course_management.bulk_delete_category') }}">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a class="btn btn-secondary btn-sm mr-1 editBtn" href="#"
                                                       ...
                                                       data-id="{{ $category->id }}" data-icon="{{ $category->icon }}"
                              ...
                              <span class="btn-label">
                                <i class="fas fa-edit"></i>
                                                    ...
                                                    <form class="deleteForm d-inline-block"
                                                          action="{{ route('admin.course_management.delete_category', ['id' => $category->id]) }}"
                                                          method="post">
