                    ...
                    <table class="table table-striped">
                      ...
                      <span class="btn-label">
                        <i class="fas fa-edit"></i>
                                    ...
                                    <a href="{{ route('admin.course_management.lesson.contents', ['id' => $lesson->id, 'course' => request()->route('id'), 'language' => $language->code]) }}"
                      ...
                      <span class="btn-label">
                        <i class="fas fa-info-circle"></i>
                                    ...
                                    <form class="lessonDeleteForm d-inline-block"
                                          action="{{ route('admin.course_management.module.delete_lesson', ['id' => $lesson->id]) }}"
                                          method="post">
