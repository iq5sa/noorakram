                  ...
                  <i class="fas fa-backward"></i>
                            ...
                            <a href="#" data-toggle="modal" data-target="#createModal"
                               class="btn btn-primary btn-sm float-lg-right float-left"><i
                                        class="fas fa-plus"></i> {{ __('Add FAQ') }}</a>

                            <button class="btn btn-danger float-right btn-sm mr-2 d-none bulk-delete"
                                    data-href="{{ route('admin.course_management.course.bulk_delete_faq') }}">
                              ...
                              <span class="btn-label">
                                <i class="fas fa-edit"></i>
                                                    ...
                                                    <form class="deleteForm d-inline-block"
                                                          action="{{ route('admin.course_management.course.delete_faq', ['id' => $faq->id]) }}"
                                                          method="post">
