                    ...
                    <div class="row">
                        <div class="col-lg-8 offset-lg-2">
                            ...
                            <form id="thanksPageForm"
                                  action="{{ route('admin.course_management.course.update_thanks_page', ['id' => $course->id]) }}"
                                  method="POST">
                                                        ...
                                                        <div class="col">
                                                            <div class="form-group {{ $language->direction == 1 ? 'rtl text-right' : '' }}">
                                                                ...
                                                                <textarea class="form-control summernote"
                                                                          name="{{ $language->code }}_thanks_page_content"
                                                                          placeholder="Enter Page Content"
                                                                          data-height="300">{{ is_null($courseData->thanks_page_content) ? '' : replaceBaseUrl($courseData->thanks_page_content, 'summernote') }}</textarea>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
