...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <form action="{{ route('admin.course_management.course.update_certificate_settings', ['id' => $course->id]) }}"
                      method="POST">
                        ...
                        <div class="row">
                            <div class="col-lg-6 offset-lg-3">
                                    ...
                                    <div class="selectgroup w-100">
                                        <label class="selectgroup-item">
                                            <input type="radio" name="certificate_status" value="1"
                                                   class="selectgroup-input" {{ $course->certificate_status == 1 ? 'checked' : '' }}>
                                            <span class="selectgroup-button">{{ __('Enable') }}</span>
                                        </label>

                                        <label class="selectgroup-item">
                                            <input type="radio" name="certificate_status" value="0"
                                                   class="selectgroup-input" {{ $course->certificate_status == 0 ? 'checked' : '' }}>
                                ...
                                <div id="certificate-settings"
                                     @if ($course->certificate_status == 1) style="display: block;"
                                        ...
                                        <div class="selectgroup w-100">
                                            <label class="selectgroup-item">
                                                <input type="radio" name="video_watching" value="1"
                                                       class="selectgroup-input" {{ $course->video_watching == 1 ? 'checked' : '' }}>
                                                <span class="selectgroup-button">{{ __('Enable') }}</span>
                                            </label>

                                            <label class="selectgroup-item">
                                                <input type="radio" name="video_watching" value="0"
                                                       class="selectgroup-input" {{ $course->video_watching == 0 ? 'checked' : '' }}>
                                                <span class="selectgroup-button">{{ __('Disable') }}</span>
                                            </label>
                                        </div>
                                        ...
                                        <div class="selectgroup w-100">
                                            <label class="selectgroup-item">
                                                <input type="radio" name="quiz_completion" value="1"
                                                       class="selectgroup-input" {{ $course->quiz_completion == 1 ? 'checked' : '' }}>
                                                <span class="selectgroup-button">{{ __('Enable') }}</span>
                                            </label>

                                            <label class="selectgroup-item">
                                                <input type="radio" name="quiz_completion" value="0"
                                                       class="selectgroup-input" {{ $course->quiz_completion == 0 ? 'checked' : '' }}>
                                                <span class="selectgroup-button">{{ __('Disable') }}</span>
                                            </label>
                                        </div>
                                    </div>
                                    ...
                                    <div id="minScore" class="dis-none">
                                        <div class="form-group">
                                            ...
                                            <div class="text-warning mb-0">Minimum quiz score needed to complete quiz of
                                                a lesson
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" name="certificate_text" rows="7"
                                                  placeholder="Enter Certificate Text">{{ $course->certificate_text }}</textarea>
                                    </div>
