...
<div class="wrapper">
    <div class="container">
        ...
        <div class="main-content">
            ...
            <h2>شكرا على تسجيلك في منصة نور اكرم.</h2>
            <p class="text-main">نحتاج فقط للتحقق من بريدك الالكتروني لضمان استفادتك من المنصة.</p>
            <a style="color: white" href="{{$mailData['url']}}" class="button">تأكيد البريد</a>
    ...
    <div class="footer">
        <p>إذا لم تكن قد قمت بالتسجيل، فما عليك سوى تجاهل هذه الرسالة الإلكترونية..</p>
